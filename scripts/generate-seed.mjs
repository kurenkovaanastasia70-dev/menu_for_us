...
const rawProducts = [
  ["chicken_breast", "Куриная грудка", "protein", 110, 23.6, 1.9, 0, 900, "g", ["chicken", "meat"], 329, "Петруха"],
  ["chicken_thigh", "Куриное бедро", "protein", 185, 21, 11, 0, 900, "g", ["chicken", "meat"], 289, "Петруха"],
  ["turkey_fillet", "Филе индейки", "protein", 117, 24, 1.9, 0, 600, "g", ["turkey", "meat"], 349, "Индилайт"],
  ["ground_turkey", "Фарш индейки", "protein", 160, 20, 8, 0, 500, "g", ["turkey", "meat"], 219, "Индилайт"],
  ["ground_chicken", "Фарш куриный", "protein", 143, 18, 8, 0, 500, "g", ["chicken", "meat"], 169, "Петруха"],
  ["beef", "Говядина", "protein", 187, 22, 11, 0, 500, "g", ["beef", "meat"], 429, "Мираторг"],
  ["ground_beef", "Фарш говяжий", "protein", 254, 17, 20, 0, 400, "g", ["beef", "meat"], 259, "Мираторг"],
  ["pork_tenderloin", "Свиная вырезка", "protein", 142, 21, 6, 0, 500, "g", ["pork", "meat"], 349, "Мираторг"],
  ["salmon", "Лосось", "protein", 208, 20, 13, 0, 400, "g", ["fish"], 699, "Русское море"],
  ["pollock", "Минтай", "protein", 72, 16, 0.9, 0, 700, "g", ["fish"], 219, "Русское море"],
  ["cod", "Треска", "protein", 82, 18, 0.7, 0, 500, "g", ["fish"], 329, "Русское море"],
  ["tuna_can", "Тунец консервированный", "protein", 96, 21, 1, 0, 185, "g", ["fish"], 149, "Магуро"],
  ["shrimp", "Креветки", "protein", 95, 20, 1.1, 0, 400, "g", ["fish"], 449, "Бухта изобилия"],
  ["eggs", "Яйца куриные", "protein", 157, 13, 11, 1, 600, "g", ["eggs"], 119, "Роскар"],
  ["tofu", "Тофу", "protein", 76, 8, 4.8, 1.9, 300, "g", ["soy", "vegetarian"], 129, "Сельский дом"],
  ["lentils", "Чечевица", "protein", 116, 9, 0.4, 20, 500, "g", ["legume", "vegetarian"], 89, "Мистраль"],
  ["chickpeas", "Нут", "protein", 164, 8.9, 2.6, 27, 450, "g", ["legume", "vegetarian"], 99, "Мистраль"],
  ["beans", "Фасоль", "protein", 127, 8.7, 0.5, 22, 400, "g", ["legume", "vegetarian"], 92, "Мистраль"],
  ["cottage_cheese", "Творог 5%", "dairy", 121, 17, 5, 1.8, 400, "g", ["dairy"], 129, "Простоквашино"],
  ["greek_yogurt", "Греческий йогурт", "dairy", 66, 8, 2, 3.5, 250, "g", ["dairy"], 89, "Савушкин"],
  ["yogurt", "Йогурт натуральный", "dairy", 60, 4, 2.5, 6, 300, "g", ["dairy"], 69, "Простоквашино"],
  ["milk", "Молоко 2.5%", "dairy", 52, 2.9, 2.5, 4.8, 900, "ml", ["dairy"], 89, "Простоквашино"],
  ["kefir", "Кефир 2.5%", "dairy", 50, 3, 2.5, 4, 900, "ml", ["dairy"], 85, "Простоквашино"],
  ["ryazhenka", "Ряженка", "dairy", 67, 3, 4, 4.2, 450, "ml", ["dairy"], 62, "Простоквашино"],
  ["cheese", "Сыр полутвёрдый", "dairy", 350, 23, 28, 0, 200, "g", ["dairy"], 189, "Радость вкуса"],
  ["mozzarella", "Моцарелла", "dairy", 280, 18, 22, 2, 200, "g", ["dairy"], 169, "Hochland"],
  ["feta", "Фета", "dairy", 264, 14, 21, 4, 200, "g", ["dairy"], 159, "Bonfesto"],
  ["sour_cream", "Сметана 15%", "dairy", 162, 2.6, 15, 3, 300, "g", ["dairy"], 79, "Простоквашино"],
  ["rice", "Рис", "grain", 130, 2.7, 0.3, 28, 900, "g", ["grain"], 92, "Мистраль"],
  ["buckwheat", "Гречка", "grain", 132, 4.5, 1.6, 25, 900, "g", ["grain"], 98, "Мистраль"],
  ["oats", "Овсянка", "grain", 379, 13, 6.2, 65, 500, "g", ["grain"], 72, "Nordic"],
  ["pasta", "Макароны", "grain", 344, 11, 1.3, 71, 450, "g", ["grain"], 69, "Barilla"],
  ["spaghetti", "Спагетти", "grain", 359, 13, 2, 70, 500, "g", ["grain"], 89, "Barilla"],
  ["potato", "Картофель", "grain", 77, 2, 0.1, 17, 2000, "g", ["vegetable"], 79, "Фермер"],
  ["bread", "Хлеб цельнозерновой", "grain", 247, 9, 3.3, 43, 350, "g", ["grain"], 69, "Коломенское"],
  ["quinoa", "Киноа", "grain", 120, 4.4, 1.9, 21, 400, "g", ["grain"], 189, "Мистраль"],
  ["bulgur", "Булгур", "grain", 83, 3.1, 0.2, 19, 450, "g", ["grain"], 95, "Мистраль"],
  ["couscous", "Кускус", "grain", 112, 3.8, 0.2, 23, 450, "g", ["grain"], 99, "Мистраль"],
  ["millet", "Пшено", "grain", 119, 3.5, 1, 23, 800, "g", ["grain"], 68, "Мистраль"],
  ["barley", "Перловка", "grain", 123, 2.3, 0.4, 28, 800, "g", ["grain"], 54, "Мистраль"],
  ["noodles", "Лапша удон", "grain", 140, 4.5, 0.5, 28, 300, "g", ["grain"], 119, "Sen Soy"],
  ["tomato", "Помидоры", "vegetable", 18, 0.9, 0.2, 3.9, 500, "g", ["vegetable"], 149, "Своя грядка"],
  ["cucumber", "Огурцы", "vegetable", 15, 0.8, 0.1, 3.6, 500, "g", ["vegetable"], 129, "Своя грядка"],
  ["onion", "Лук репчатый", "vegetable", 40, 1.1, 0.1, 9, 1000, "g", ["vegetable"], 49, "Своя грядка"],
  ["garlic", "Чеснок", "vegetable", 149, 6.4, 0.5, 33, 150, "g", ["vegetable"], 59, "Своя грядка"],
  ["carrot", "Морковь", "vegetable", 41, 0.9, 0.2, 10, 1000, "g", ["vegetable"], 45, "Своя грядка"],
  ["cabbage", "Капуста белокочанная", "vegetable", 25, 1.3, 0.1, 6, 1500, "g", ["vegetable"], 55, "Своя грядка"],
  ["broccoli", "Брокколи", "vegetable", 34, 2.8, 0.4, 7, 400, "g", ["vegetable"], 149, "4 сезона"],
  ["spinach", "Шпинат", "vegetable", 23, 2.9, 0.4, 3.6, 400, "g", ["vegetable"], 129, "4 сезона"],
  ["bell_pepper", "Перец болгарский", "vegetable", 27, 1, 0.3, 6, 500, "g", ["vegetable"], 179, "Своя грядка"],
  ["zucchini", "Кабачки", "vegetable", 17, 1.2, 0.3, 3.4, 800, "g", ["vegetable"], 89, "Своя грядка"],
  ["eggplant", "Баклажаны", "vegetable", 25, 1.1, 0.2, 6, 600, "g", ["vegetable"], 119, "Своя грядка"],
  ["beet", "Свёкла", "vegetable", 43, 1.6, 0.2, 10, 1000, "g", ["vegetable"], 49, "Своя грядка"],
  ["lettuce", "Салат айсберг", "vegetable", 14, 0.9, 0.1, 3, 300, "g", ["vegetable", "salad"], 89, "Белая дача"],
  ["mushroom", "Шампиньоны", "vegetable", 27, 4.3, 1, 1, 400, "g", ["vegetable"], 119, "Грибной рай"],
  ["cherry_tomato", "Черри", "vegetable", 18, 0.9, 0.2, 3.9, 250, "g", ["vegetable"], 129, "Своя грядка"],
  ["green_beans", "Стручковая фасоль", "vegetable", 31, 1.8, 0.1, 7, 400, "g", ["vegetable"], 139, "4 сезона"],
  ["cauliflower", "Цветная капуста", "vegetable", 25, 1.9, 0.3, 5, 500, "g", ["vegetable"], 129, "4 сезона"],
  ["pumpkin", "Тыква", "vegetable", 26, 1, 0.1, 7, 1000, "g", ["vegetable"], 69, "Своя грядка"],
  ["corn", "Кукуруза", "vegetable", 96, 3.3, 1.4, 19, 340, "g", ["vegetable"], 79, "Бондюэль"],
  ["peas", "Горошек", "vegetable", 81, 5.4, 0.4, 14, 400, "g", ["vegetable"], 89, "4 сезона"],
  ["celery", "Сельдерей", "vegetable", 16, 0.7, 0.2, 3, 400, "g", ["vegetable"], 79, "Своя грядка"],
  ["dill", "Укроп", "vegetable", 43, 3.5, 0.5, 7, 50, "g", ["vegetable"], 39, "Своя грядка"],
  ["parsley", "Петрушка", "vegetable", 36, 3, 0.4, 6, 50, "g", ["vegetable"], 39, "Своя грядка"],
  ["ginger", "Имбирь", "vegetable", 80, 1.8, 0.8, 18, 100, "g", ["vegetable"], 89, "Своя грядка"],
  ["banana", "Бананы", "fruit", 89, 1.1, 0.3, 23, 1000, "g", ["fruit"], 119, "Эквадор"],
  ["apple", "Яблоки", "fruit", 52, 0.3, 0.2, 14, 1000, "g", ["fruit"], 129, "Сады Кубани"],
  ["orange", "Апельсины", "fruit", 47, 0.9, 0.1, 12, 1000, "g", ["fruit"], 139, "Марокко"],
  ["lemon", "Лимоны", "fruit", 29, 1.1, 0.3, 9, 500, "g", ["fruit"], 99, "Турция"],
  ["berries", "Ягодный микс", "fruit", 43, 0.7, 0.4, 9, 300, "g", ["fruit"], 199, "4 сезона"],
  ["kiwi", "Киви", "fruit", 61, 1.1, 0.5, 15, 500, "g", ["fruit"], 149, "Италия"],
  ["pear", "Груши", "fruit", 57, 0.4, 0.1, 15, 800, "g", ["fruit"], 159, "Сады Кубани"],
  ["olive_oil", "Оливковое масло", "fat", 884, 0, 100, 0, 500, "ml", ["fat"], 429, "Borges"],
  ["sunflower_oil", "Подсолнечное масло", "fat", 899, 0, 100, 0, 900, "ml", ["fat"], 119, "Слобода"],
  ["butter", "Сливочное масло", "fat", 748, 0.5, 82.5, 0.8, 180, "g", ["fat", "dairy"], 169, "Простоквашино"],
  ...
  ["coconut_milk", "Кокосовое молоко", "pantry", 197, 2, 21, 3, 400, "ml", ["pantry"], 149, "Aroy-D"],
...
for (const product of rawProducts) {
  ...
  for (const store of stores) {
    const factor = storePriceFactor[store.id];
    const jitter = 1 + ((id.length + store.id.length) % 7) * 0.01 - 0.03;
    storeProducts.push({
      id: `${store.id}_${id}`,
      ...
      brand,
      package_weight: pack,
      price: Math.round(price * factor * jitter),
      available: true,
      url: "",
