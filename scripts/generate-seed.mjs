...
const rawProducts = [
  ...
  ["corn", "Кукуруза сладкая", "vegetable", 96, 3.3, 1.4, 19, 340, "g", ["vegetable", "corn"], 69, "Бондюэль"],
...
const rawRecipes = [
  ...
  { id: "squid_rings", name: "Кальмары с овощами", cuisine: "mediterranean", meal_type: "dinner", cooking_time: 20, difficulty: "easy", servings: 1, protein_source: "fish", tags: ["dinner"], instructions: ["Обжарить кальмар с перцем и луком, подать с рисом."], ingredients: [n("squid", 160), n("bell_pepper", 80), n("onion", 40), n("rice", 60), n("olive_oil", 8)] },
  { id: "pelmeni_sour_cream", name: "Пельмени со сметаной", cuisine: "russian", meal_type: "lunch", cooking_time: 15, difficulty: "easy", servings: 1, protein_source: "beef", tags: ["lunch", "quick"], instructions: ["Отварить пельмени, подать со сметаной."], ingredients: [n("pelmeni", 250), n("sour_cream", 40)] },
  { id: "frozen_chicken_cutlets", name: "Котлеты куриные с/м с гарниром", cuisine: "russian", meal_type: "dinner", cooking_time: 25, difficulty: "easy", servings: 1, protein_source: "chicken", tags: ["dinner", "quick"], instructions: ["Запечь или обжарить котлеты, подать с картофелем и салатом."], ingredients: [n("cutlets_chicken_frozen", 180), n("potato", 180), n("cucumber", 80), n("sunflower_oil", 5)] },
  { id: "frozen_beef_cutlets", name: "Котлеты говяжьи с/м с гречкой", cuisine: "russian", meal_type: "lunch", cooking_time: 25, difficulty: "easy", servings: 1, protein_source: "beef", tags: ["lunch", "quick"], instructions: ["Приготовить котлеты, подать с гречкой."], ingredients: [n("cutlets_beef_frozen", 180), n("buckwheat", 70), n("onion", 30), n("sunflower_oil", 5)] },
  { id: "nuggets_veg", name: "Наггетсы с овощами", cuisine: "european", meal_type: "dinner", cooking_time: 20, difficulty: "easy", servings: 1, protein_source: "chicken", tags: ["dinner", "quick"], instructions: ["Запечь наггетсы, подать с овощами."], ingredients: [n("nuggets_chicken", 160), n("tomato", 80), n("cucumber", 80), n("fries_frozen", 100)] },
  ...
  { id: "side_corn", name: "Салат с кукурузой", cuisine: "european", meal_type: "dinner", cooking_time: 10, difficulty: "easy", servings: 1, protein_source: "vegetables", tags: ["salad", "side", "vegetables"], instructions: ["Смешайте кукурузу с огурцом и помидором.", "Добавьте зелень и заправьте маслом.", "Посолите и сразу подайте."], ingredients: [n("canned_corn", 80), n("cucumber", 70), n("tomato", 70), n("dill", 5), n("sunflower_oil", 8)] },
